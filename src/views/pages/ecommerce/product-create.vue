          ...
          <div class="card-body">
            <form-wizard color="#3bafda" ref="wizard">
              <tab-content title="General">
                ...
                <div>
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group mb-3">
                        <label class="form-label" for="product-reference">
                          Reference
                          <span class="text-danger">*</span>
                        </label>
                        <input
                  ...
                  <div class="form-group mb-3">
                    ...
                    <div class="radio form-check-inline">
                      <input
                        ...
                        checked
                      />
                      <label class="form-label" for="inlineRadio1">Online</label>
                    </div>
                    <div class="radio form-check-inline">
                      <input
                        type="radio"
                        ...
                        name="radioInline"
                      />
                      <label class="form-label" for="inlineRadio2">Offline</label>
                    </div>
                    <div class="radio form-check-inline">
                      <input
                        type="radio"
              ...
              <tab-content title="Meta Data">
                ...
                <form>
                  <div class="form-group mb-3">
                    <label class="form-label" for="product-meta-title">Meta title</label>
                    <input
                      type="text"
                      class="form-control"
                  ...
                  <div class="form-group mb-3">
                    <label class="form-label" for="product-meta-keywords">Meta Keywords</label>
                    <input
                      type="text"
                      class="form-control"
