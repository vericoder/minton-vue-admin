...
<div class="card">
    <div class="card-body">
        <b-dropdown class="float-end" toggle-class="card-drop p-0" variant="black" right>
        ...
        <div class="table-responsive browser_users mb-0">
            <table class="table mb-0">
                ...
                <tbody>
                    <tr>
                        <td>
                            <i class="fab fa-chrome me-2 text-success font-16"></i>Chrome
                        </td>
                    ...
                    <tr>
                        <td>
                            <i class="fab fa-safari me-2 text-info font-16"></i>Safari
                        </td>
                    ...
                    <tr>
                        <td>
                            <i class="fab fa-internet-explorer me-2 text-warning font-16"></i>Internet-Explorer
                        </td>
                    ...
                    <tr>
                        <td>
                            <i class="fab fa-opera me-2 text-danger font-16"></i>Opera
                        </td>
                    ...
                    <tr>
                        <td>
                            <i class="fab fa-firefox me-2 text-blue font-16"></i>Firefox
                        </td>
