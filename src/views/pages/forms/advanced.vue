        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <label class="mt-3 form-label">Multiple Select</label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div v-if="maxlen" class="text-center">
                        <p class="badge position-absolute" :class="{ 'bg-success': maxlen.length !== 10,
                            'bg-danger': maxlen.length === 10 }">{{ maxlen.length }} / 10</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="text-center">
                            <p v-if="data" class="badge position-absolute" :class="{ 'bg-success': data.length !== 25,
                            'bg-danger': data.length === 25 }">{{ data.length }} / 25</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="text-center">
                            <p v-if="option" class="badge position-absolute" :class="{ 'bg-success': option.length !== 25,
                    ...
                    <div>
                        ...
                        <div class="text-center">
                            <p v-if="textarea" class="badge position-absolute" :class="{ 'bg-success': textarea.length !== 225,
