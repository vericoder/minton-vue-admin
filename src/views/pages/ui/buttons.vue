        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="button-list">
              ...
              <b-button variant="success" class="width-sm ms-1">Small</b-button>
              <b-button variant="info" class="width-md ms-1">Middle</b-button>
          ...
          <div class="card-body">
            ...
            <div class="button-list">
              ...
              <b-button variant="dark">
                <i class="far fa-envelope me-1"></i> Share
              </b-button>
              <b-button variant="info">
                <i class="fa fa-cloud me-1"></i> Cloud Hosting
              </b-button>
              <b-button variant="warning">
                Donate
                <i class="mdi mdi-currency-btc ms-1"></i>
              </b-button>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-6">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="fileupload btn btn-secondary mt-1 ms-1">
