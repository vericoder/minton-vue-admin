            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="mt-3">
                  <div class="avatar-md">
                    <span
                      class="avatar-title bg-soft-info text-info font-20 rounded"
                    >
                      MD
                    </span>
                  </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="mt-3">
                  <div class="avatar-xl">
                    <span
                      class="avatar-title bg-soft-warning text-warning font-24 rounded"
                    >
                      XL
                    </span>
                  </div>
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="mt-3">
                  <div class="avatar-md">
                    <span
                      class="avatar-title bg-soft-secondary text-secondary font-20 rounded-circle"
                    >
                      MD
                    </span>
                  </div>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="mt-3">
                  <div class="avatar-lg">
                    <span
                      class="avatar-title bg-light text-dark font-22 rounded-circle"
                    >
                      LG
                    </span>
                  </div>
