        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <i class="mdi mdi-message-outline me-1"></i> Facebook Messenger
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-apple me-1"></i> Apple Technology Company
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-lifebuoy me-1"></i> Intercom Support System
              </li>
              <li class="list-group-item">
                <i class="mdi mdi-credit-card-outline me-1"></i> Paypal Payment
                Gateway
              </li>
            </ul>
          </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">
              ...
              <code>.list-group-item</code> for large hit areas, you can do
              that, too.
            </p>
