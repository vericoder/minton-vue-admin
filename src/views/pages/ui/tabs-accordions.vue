          ...
          <b-card no-body class="mb-1">
            <b-card-header header-tag="header" role="tab">
              <h5 class="m-0">
                ...
                >
                  <i class="mdi mdi-help-circle me-1 text-primary"></i>What is
                  Vakal text here?
                </a>
              </h5>
            </b-card-header>
            ...
            <b-card-header header-tag="header" role="tab">
              <h5 class="m-0">
                <a
                  ...
                  href="javascript: void(0);"
                >
                  <i class="mdi mdi-help-circle me-1 text-primary"></i>Why use
                  Vakal text here?
                </a>
              </h5>
            </b-card-header>
            ...
            <b-card-header header-tag="header" role="tab">
              <h5 class="m-0">
                <a
                  ...
                  href="javascript: void(0);"
                >
                  <i class="mdi mdi-help-circle me-1 text-primary"></i>How many
                  variations exist?
                </a>
              </h5>
            </b-card-header>
