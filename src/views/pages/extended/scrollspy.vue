                ...
                <b-col cols="4">
                  <b-navbar v-b-scrollspy:scrollspy-nested class="flex-column">
                    ...
                    <b-nav pills vertical>
                      ...
                      <b-nav pills vertical>
                        <b-nav-item class="ms-3 my-1" href="#item-1-1"
                          >Item 1-1</b-nav-item
                        >
                        <b-nav-item class="ms-3 my-1" href="#item-1-2"
                          >Item 1-2</b-nav-item
                        >
                      </b-nav>
                      ...
                      <b-nav pills vertical>
                        <b-nav-item class="ms-3 my-1" href="#item-3-1"
                          >Item 3-1</b-nav-item
                        >
                        <b-nav-item class="ms-3 my-1" href="#item-3-2"
                          >Item 3-2</b-nav-item
                        >
                      </b-nav>
                    </b-nav>
