      ...
      <div class="col-lg-4 col-xl-4">
        <div class="card">
          <div class="card-body text-center">
            ...
            <button
              type="button"
              class="btn btn-success btn-xs mb-2 me-1"
            >
              Follow
            </button>
            <button
                    ...
                    <table class="table table-borderless mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>10/15/2018</td>
                          <td>
                            <span class="badge bg-info">Work in Progress</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>28/09/2018</td>
                          <td>
                            <span class="badge bg-pink">Done</span>
                          </td>
              ...
              <b-tab>
                ...
                <form>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label" for="social-fb"
                          >Facebook</label
                        >
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label" for="social-tw"
                          >Twitter</label
                        >
                        <div class="input-group">
                          <div class="input-group-text">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label" for="social-insta"
                          >Instagram</label
                        >
                        <div class="input-group">
                          <div class="input-group-text">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label class="form-label" for="social-lin"
                          >Linkedin</label
                        >
                        <div class="input-group">
                          <div class="input-group-text">
