    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <div
              class="fileupload btn btn-success mb-3"
            >
              <span>
                <i class="mdi mdi-cloud-upload me-1"></i> Upload Files
              </span>
              <form>
              ...
              <table class="table table-centered mb-0">
                <thead class="table-light">
                  <tr>
                    ...
                    <th class="fw-medium">Date Modified</th>
                    <th class="fw-medium">Size</th>
                    <th class="fw-medium">Contributors</th>
                    <th
