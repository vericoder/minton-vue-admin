...
<template>
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex mt-3" v-for="(item, index) in leadsData" :key="index">
                <img class="avatar-sm align-self-center me-3 rounded-circle" :src="item.profile" width="40" alt="Generic placeholder image" />
                <div class="flex-1">
                    <span class="badge float-end" :class="{
